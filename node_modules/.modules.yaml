...
hoistedDependencies:
  ...
  p-locate@5.0.0:
    p-locate: private
  packages/agent:
    '@kynetic-bot/agent': private
  packages/bot:
    '@kynetic-bot/bot': private
  packages/channels:
    '@kynetic-bot/channels': private
  packages/core:
    '@kynetic-bot/core': private
  packages/memory:
    '@kynetic-bot/memory': private
  packages/messaging:
    '@kynetic-bot/messaging': private
  parent-module@1.0.1:
...
pendingBuilds: []
prunedAt: Wed, 28 Jan 2026 09:04:25 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - '@rollup/rollup-win32-x64-msvc@4.57.0'
  - fsevents@2.3.3
storeDir: /home/chapel/.local/share/pnpm/store/v3
